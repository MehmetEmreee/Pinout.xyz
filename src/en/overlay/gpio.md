...
Do not apply 5 V logic directly to a GPIO pin. Treat GPIO outputs as control signals and use an appropriate driver, buffer or level shifter for loads and voltage domains.
